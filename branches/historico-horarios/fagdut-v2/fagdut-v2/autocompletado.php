 ...
 * 
 * @property autenticacion $autenticacion Servicios de control de usuarios
 * @property Dompdf_Lib $Dompdf_Lib
 * 
 * @property Usuarios_Model $Usuarios_Model Modelo de tabla de Usuarios.
 * @property Personal_Model $Personal_Model Modelo de tabla Personal
 * @property Marcas_Model $Marcas_Model Modelo de tabla Marcas
 * @property Horarios_Personal_Model $Horarios_Personal_Model Modelo de la tabla HorariosPersonal
 */
class CI_Controller{}
